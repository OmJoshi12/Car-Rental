...
CAR_IMAGES = {
    "Toyota Camry": "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=600&h=400&fit=crop",
...
cars = [
    {"id": 1, "agency_id": 1, "vehicle_model": "Toyota Camry", "vehicle_number": "ABC-1234", "seating_capacity": 5, "rent_per_day": 4150.00, "image": CAR_IMAGES["Toyota Camry"]},
    {"id": 2, "agency_id": 1, "vehicle_model": "Honda Accord", "vehicle_number": "XYZ-5678", "seating_capacity": 5, "rent_per_day": 4980.00, "image": CAR_IMAGES["Honda Accord"]},
    {"id": 3, "agency_id": 1, "vehicle_model": "BMW 3 Series", "vehicle_number": "DEF-9012", "seating_capacity": 5, "rent_per_day": 9960.00, "image": CAR_IMAGES["BMW 3 Series"]},
    {"id": 4, "agency_id": 1, "vehicle_model": "Mercedes C-Class", "vehicle_number": "GHI-3456", "seating_capacity": 5, "rent_per_day": 10790.00, "image": CAR_IMAGES["Mercedes C-Class"]},
    {"id": 5, "agency_id": 1, "vehicle_model": "Toyota Innova", "vehicle_number": "JKL-7890", "seating_capacity": 7, "rent_per_day": 6640.00, "image": CAR_IMAGES["Toyota Innova"]},
    {"id": 6, "agency_id": 1, "vehicle_model": "Audi A4", "vehicle_number": "MNO-1234", "seating_capacity": 5, "rent_per_day": 9130.00, "image": CAR_IMAGES["Audi A4"]},
    {"id": 7, "agency_id": 1, "vehicle_model": "Lexus RX", "vehicle_number": "PQR-5678", "seating_capacity": 5, "rent_per_day": 11620.00, "image": CAR_IMAGES["Lexus RX"]},
    {"id": 8, "agency_id": 1, "vehicle_model": "Tesla Model 3", "vehicle_number": "STU-9012", "seating_capacity": 5, "rent_per_day": 8300.00, "image": CAR_IMAGES["Tesla Model 3"]}
]

bookings = [
    {"id": 1, "car_id": 1, "customer_id": 2, "start_date": "2024-01-15", "number_of_days": 3, "total_price": 12450.00, "status": "confirmed"}
]
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2026 Premium Car Rental. All rights reserved. | Designed with excellence</p>
            </div>
        </div>
    </footer>
</body>
